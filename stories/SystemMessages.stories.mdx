...
## General usage
  ...
  <Preview>
    <Story name="Info Sample">
      <Banner type="info" text="Scheduled maintenance in our servers tomorrow 5 Mar @ 10AM." icon="calendar" buttonText="Dismiss" onClick={() => alert("Button to DISMISS Banner was clicked!")} />
      <br />
      <Alert type="info" text="Good news! Now you can add your expenses to your monthly spreadsheet." icon="coin" buttonText="Dismiss" onClick={() => alert("Button to DISMISS Alert was detected!")} />
    </Story>
  </Preview>
  ...
  <Preview>
    <Story name="Warn Sample">
      <Banner type="warn" text="We couldn't renew your plan. Please check your billing info." icon="coin" buttonText="Go to billing" onClick={() => alert("Button to GO TO BILLING was clicked in Banner!")} />
      <br />
      <Alert type="warn" text="You need to be signed in to use this feature." icon="calendar" buttonText="Login" onClick={() => alert("Button to LOGIN was clicked in Allert!")} />
    </Story>
  </Preview>
  ...
  <Preview>
    <Story name="Error Sample">
      <Banner type="error" text="Looks like we're having trouble retrieving some information. Please refresh the page." icon="reload" buttonText="Refresh" onClick={() => alert("Button to REFRESH was clicked in Banner!")} />
      <br />
