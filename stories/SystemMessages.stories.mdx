  ...
  <div className="doc-anatomy-block">
    ...
    <div className="columns">
      <div className="column is-half">
        ...
        <p><strong className="doc-pink">Vertical padding (top and bottom):</strong> fixed value of 12px</p>
      </div>
    </div>
    <div className="columns is-multiline">
      <div className="column">
        <p><strong className="doc-pink">Horizontal padding (left and right):</strong></p>
