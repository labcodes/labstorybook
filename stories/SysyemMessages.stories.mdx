...
## General usage
  ...
  <div class="columns">
    <div class="column">
      ...
      <p class="doc-em-block"><strong>For tablet-up</strong> alerts never write a message that uses more than <strong>2 lines</strong>. <br />
      <strong>For mobile</strong>, never more than <strong>3 lines</strong>. <br />
